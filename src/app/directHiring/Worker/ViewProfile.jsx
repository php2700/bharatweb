...
const assignedWorker = location.state?.assignedWorker || null;
  ...
  const [isAccepted, setIsAccepted] = useState(!!assignedWorker);
  const [isCancelled, setIsCancelled] = useState(false);
  const [showModal, setShowModal] = useState(false);

  // Debug: Log profile and state to diagnose issue
  ...
  const ProfileCard = ({ name, fees, image, buttons, showContact = false }) => (
    <div className="flex flex-col md:flex-row justify-between items-center w-full gap-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        />
        <div>
          <h3 className="font-semibold text-xl text-[#191A1D]">{name}</h3>
      ...
      {/* Middle - Contact Section (if applicable) */}
      {showContact && (
        <div className="flex flex-col items-center">
          <h4 className="font-semibold text-lg mb-2">Contact with him</h4>
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        ...
        <div className="bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div>
              ...
              <div className="border border-[#228B22] rounded-lg p-4 mb-4 bg-[#F5F5F5]">
                <p className="text-gray-700 tracking-tight">
                  {work.skills || "Detailed skills information will be provided soon."}
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Profile Section */}
          <div className="mt-6 border border-[#228B22] bg-[#F5F5F5] shadow-md rounded-lg p-4 mx-auto max-w-[95%]">
            {isCancelled ? (
              <ProfileCard
                name={profile.name}
                fees={profile.fees}
              ...
              <ProfileCard
                ...
                buttons={
                  <>
                    ...
                    <Link to="/assign-work" state={{ work }}>
          ...
          {assignedWorker && (
            <div className="mt-6 p-4">
              <h1 className="text-lg font-bold mb-2">Assigned Person</h1>
              <div className="mt-6 border border-[#228B22] bg-[#F5F5F5] shadow-md rounded-lg p-4 mx-auto max-w-[98%] flex items-center gap-4">
                {/* Profile Image */}
                <img
                ...
                <div className="flex flex-col">
                  ...
                  <button className="mt-2 bg-[#228B22] text-white px-4 py-2 rounded-lg hover:bg-green-700 text-sm font-semibold w-[170px]">
                    View Profile
                  </button>
                </div>
              </div>
                ...
                <table className="min-w-full text-left text-gray-600">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="px-4 py-2 text-[#228B22] font-semibold">Paid</td>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 max-w-sm w-full shadow-lg">
            ...
            <p className="text-gray-600 mb-6">
              Do you really want to cancel this task and create a dispute? This action cannot be undone.
            </p>
