      ...
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        <div className="bg-white shadow-md rounded-lg overflow-hidden">
          {images.length > 0 ? (
            ...
            <div
              onClick={() => setOpenImage(defaultWorkImage)}
              ...
              <div className="text-right space-y-2 tracking-tight">
                ...
                <div className="flex flex-wrap items-center gap-2 mt-2 mb-2">
                  <span className="text-gray-600 font-semibold  ">
                    Status:{" "}
                    <span
                      className={`px-4 py-1.5 rounded-full text-white text-sm font-medium font-medium inline-block min-w-[100px] text-center
                      ${
