          ...
          <>
            ...
            {/* Responsive Banner – Desktop Full Size, Mobile Smaller & Padded */}
              ...
              <div className="w-full max-w-[95%] mx-auto relative rounded-3xl overflow-hidden shadow-2xl border border-[#228B22]">
                <img
                  src={Promise}
                  className="w-full h-[180px] sm:h-[240px] lg:h-[280px] object-cover"
                />
                <div className="absolute inset-0 flex items-center justify-center md:justify-end md:pr-12 lg:pr-20">
                  <button
                    onClick={handlePlan}
                    className="bg-[#228B22] hover:bg-[#1a6d1a] text-white font-bold px-4 py-2 sm:px-4 sm:py-2 rounded-2xl shadow-2xl transform transition-all duration-300 hover:scale-110  text-sm md:text-lg"
                  >
                    Upgrade Now
                  </button>
                </div>
