...
export default function ServiceProviderHome() {
  ...
  const LocationText = ({ text, id }) => {
    ...
    return (
      <div className="flex items-start gap-2 mt-2 text-gray-600 text-sm w-full">
        <FaMapMarkerAlt
          className="text-[#228B22] flex-shrink-0 mt-1"
          size={16}
        />
  ...
  "
          ...
          {/* <div className="md:w-[90%] w-[100%] mx-auto relative mt-4">
                <img
                  src={Promise}
                  className="w-full rounded-2xl object-cover h-[150px] border border-[#228B22]"
                />
                <div className="hidden max-md:!hidden md:block absolute right-[100px] top-1/2 -translate-y-1/2">
                  <button
                    onClick={handlePlan}
                    className="bg-[#228B22] text-white px-6 py-2 rounded-xl shadow"
                  >
                    Upgrade Now
                  </button>
                </div>
          ...
          <div className="w-full mt-4 px-6 md:px-4 lg:px-0">
            <div className="w-full max-w-[95%] mx-auto relative rounded-3xl overflow-hidden shadow-2xl border border-[#228B22]">
              {/* Image — smaller height on all screens */}
              <img
                src={Promise}
                className="w-full 
                 h-[90px]        /* mobile smaller */
                 sm:h-[120px]    /* tablet smaller */
                 lg:h-[150px]    /* desktop smaller */
                 object-cover"
              />

              {/* Button Position */}
              <div className="absolute inset-0 flex items-center justify-end pr-4 sm:pr-8 md:pr-12 lg:pr-20">
                <button
                  onClick={handlePlan}
                  className="
          bg-[#228B22] hover:bg-[#1a6d1a] text-white font-bold 
          px-3 py-1.5            /* smaller button */
          sm:px-3 sm:py-2 
          rounded-2xl shadow-2xl
          transform transition-all duration-300 hover:scale-105
          text-xs sm:text-sm md:text-base cursor-pointer   /* smaller text sizes */
        "
                >
                  Upgrade Now
                </button>
          ...
          <div className="md:w-[70%] w-[90%] mx-auto mt-8 flex items-center justify-between p-4 rounded-lg border border-white shadow-lg bg-[#CEFFDE]">
            ...
            <div className="toggle-wrapper">
              <button
                onClick={handleToggle}
                className={`cursor-pointer toggle-button w-[40px] h-[25px] flex items-center rounded-full p-1 transition-colors duration-300 ${
                  isEmergencyOn
                    ? "bg-[#228B22] justify-end"
                    : "bg-[#DF1414] justify-start"
                }`}
                  ...
                  {visibleDirectHiring.map((card) => (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between mt-3">
                        <h3 className="text-lg font-semibold text-[#228B22] truncate w-[70%]">
                          {capitalizeFirst(card.work)}
                        </h3>
                      ...
                      {/* Fixed Location */}
                      <LocationText
                        text={card.location || "Location not available"}
                        id={card.id}
                      />

                      <div className="mt-auto pt-3">
                        <div
                          className="px-1 py-2 rounded-lg text-[#228B22] text-sm border border-[#228B22] w-full font-semibold text-center cursor-pointer hover:bg-[#228B22] hover:text-white transition"
                          onClick={() =>
                            navigate(`/hire/worker/order-detail/${card.id}`)
                          }
                        >
            ...
            <div className="max-w-[90%] mx-auto mt-[50px]">
              <div className="flex items-center justify-between mb-4">
                ...
                {bidding.length > 4 && (
                  <button
                    onClick={() => handleSeeAll("/bidding/recent-post")}
                    className="text-black font-medium hover:text-[#228B22]"
                  >
                    See All
                  </button>
                )}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {visibleEmergency.map((card) => (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mt-3">
                          <h3 className="text-lg font-semibold text-[#228B22] truncate w-full">
                            {capitalizeFirst(card.work)}
                          </h3>
                        </div>
