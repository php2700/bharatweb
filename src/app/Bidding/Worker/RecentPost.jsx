...
export default function RecentPost() {
  ...
  const [expandedAddressIds, setExpandedAddressIds] = useState([]); // 👈 added state
                  ...
                  <div className="md:col-span-8 p-4 space-y-2">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 mt-4">
                      ...
                      <div className="text-gray-800 flex items-center px-1 py-1 rounded-full text-sm mt-2 w-fit">
                        ...
                        <span className="max-w-[200px] sm:max-w-[300px] md:max-w-[400px] break-words">

                          {expandedAddressIds.includes(worker._id)

                            ? worker.location

                            : worker.location?.length > 40

                              ? worker.location.slice(0, 40) + "..."
                        ...
                        {worker.location?.length > 40 && (
                          ...
                          <button
                            ...
                            onClick={() => {
                              ...
                              if (expandedAddressIds.includes(worker._id)) {
