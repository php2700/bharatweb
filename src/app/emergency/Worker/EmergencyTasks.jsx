...
export default function EmergencyTasks() {
  ...
  const [expandedAddressIds, setExpandedAddressIds] = useState([]); // Added state for "See More/Less"
                ...
                >
                  ...
                  <div className="w-2/3 p-4 flex flex-col justify-between">
                    ...
                    <div className="flex justify-between items-center mt-4">
                      ...
                      {/* Address with See More / See Less functionality */}
                      ...
                      <div className="text-gray-800 flex items-center px-1 py-1 rounded-full text-sm mt-2 w-fit">
                        ...
                        <FaMapMarkerAlt
                          ...
                          color="#228B22" // Using the green color from recent post

                          className="mr-2 flex-shrink-0"

                        />

                        <span className="max-w-[150px] sm:max-w-[200px] break-words"> {/* Adjusted max-width for smaller card */}

                          {expandedAddressIds.includes(task.id)

                            ? task.location

                            : task.location?.length > 25 // Adjusted length for smaller card

                              ? task.location.slice(0, 25) + "..."
                        ...
                        {task.location?.length > 25 && ( // Adjusted length for smaller card
                          ...
                          <button
                            ...
                            onClick={() => {
                              ...
                              if (expandedAddressIds.includes(task.id)) {

                                setExpandedAddressIds(

                                  expandedAddressIds.filter(
                            ...
                            className="text-[#228B22] font-medium ml-2 hover:underline"
                      ...
                      <button
                        ...
                        className="text-[#228B22] py-1 px-7 border border-[#228B22] rounded-lg hover:bg-[#228B22] hover:text-white transition" // Added hover styles
