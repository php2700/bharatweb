...
export default function Header() {
  ...
  // ✅ mark all as read and trigger a manual refresh
  const handleNotificationClick = async () => {
    ...
    if (nextState) {
      try {
        ...
        // 🔁 refresh notifications by toggling state
  ...
  const handleRedirectNotification = (notif) => {
    ...
    // Example: navigate(`/notification/${notif._id}`);
  };
                          ...
                          <div key={i}>
                            ...
                            {section.items.map((notif, idx) => (
                              ...
                              >
                                ...
                                <span className="text-gray-400 text-xs font-medium pointer-events-none">
                                  {section.section}
                                </span>
                              </div>
                            ))}
